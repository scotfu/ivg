from . import app
from .views import CaseView, CaseQueryView, UploadView, IndexView, KmeansView, AggregationView, HistogramView
...
app.add_url_rule('/case/<case_name>/histogram/<dimension>/', view_func=HistogramView.as_view('histogram'))
